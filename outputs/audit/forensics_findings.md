...
| Outlet_Type typos normalised | 979 | cleaned | 'Bakry'->'Bakery' (n=394); 'Grocry'->'Grocery' (n=389); ' Eatery '->'Eatery' (n=196) | 3 distinct typo->canonical mappings applied |
...
| Stockout months (zero sandwiched between non-zero) | 82,036 | flagged_for_modeling |  | Used as constraint indicator in Phase 5 (not quarantined). |
| Dead-then-resurrected outlets | 2,730 | flagged | OUT_00406; OUT_00408; OUT_00420; OUT_00430; OUT_00436 | >= 6 consecutive zero months then resumed — flagged for review. |